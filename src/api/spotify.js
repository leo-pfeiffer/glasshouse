...
const getCurrentlyPlaying = function () {
    const url = "https://glasshouse-341514.nw.r.appspot.com/api/v1/spotify/currently-playing"
    return retrieve(url)
}


const getTopArtists = async function () {
    const url = "https://glasshouse-341514.nw.r.appspot.com/api/v1/spotify/top-artists"
...
const getTopTracks = async function () {
    const url = "https://glasshouse-341514.nw.r.appspot.com/api/v1/spotify/top-tracks"
